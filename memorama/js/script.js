...
const MAXIMOS_INTENTOS = 8, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "./img/gpsegurosazul.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
    ...
    methods: {
        ...
        indicarFracaso() {
            Swal.fire({
                    title: "Perdiste",
                    html: `
                <img class="img-fluid" src="./img/contigo.png" alt="Perdiste">
        ...
        indicarVictoria() {
            Swal.fire({
                    title: "¡Ganaste!",
                    html: `
                <img class="img-fluid" src="./img/juntos.png" alt="Ganaste">
